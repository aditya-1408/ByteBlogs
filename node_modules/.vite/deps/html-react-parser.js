...
var require_html_to_dom = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var CASE_SENSITIVE_TAG_NAMES_MAP = [
		"animateMotion",
		"animateTransform",
		"clipPath",
		"feBlend",
		...
		"radialGradient",
		"textPath"
	].reduce(function(accumulator, tagName) {
	...
	if (typeof DOMParser === "function") {
		...
		*/
		parseFromString = function(html, tagName, trustedTypePolicy) {
			if (tagName) html = "<".concat(tagName, ">").concat(html, "</").concat(tagName, ">");
		...
		switch (firstTagName) {
			case HTML:
				...
				if (!hasOpenTag(html, BODY)) {
					...
					(_c = element === null || element === void 0 ? void 0 : element.parentNode) === null || _c === void 0 || _c.removeChild(element);
				}
				return doc.querySelectorAll(HTML);
			case HEAD:
			case BODY:
				var elements = parseFromDocument(html, void 0, trustedTypePolicy).querySelectorAll(firstTagName);
				/* v8 ignore next */
				if (hasOpenTag(html, BODY) && hasOpenTag(html, HEAD)) return (_e = (_d = elements[0].parentNode) === null || _d === void 0 ? void 0 : _d.childNodes) !== null && _e !== void 0 ? _e : createNodeList();
				return elements;
			/* v8 ignore start */
			default:
